...
flyspell texinfo tex-mode tooltip vcursor wid-edit woman term man"
  ...
  (color-theme-install
   '(color-theme-emacs-21
     ...
     (font-lock-string-face ((t (:foreground "#bd2c2c"))))
     (font-lock-type-face ((t (:foreground "ForestGreen"))))
     (font-lock-variable-name-face ((t (:foreground "black"))))
...
:family "outline-courier new"))))
     ...
     (fixed-pitch ((t (:family "courier"))))
     (font-lock-builtin-face ((t (:foreground "black"))))
     (font-lock-comment-face ((t (:foreground "c0c0c0" :background "#fffafa"))))
     (font-lock-constant-face ((t (:foreground "darkblue"))))
     (font-lock-doc-face ((t (:background "#f0f0f0"))))
     (font-lock-function-name-face ((t (:bold t :underline nil :weight
bold))))
     (font-lock-keyword-face ((t (:foreground "blue"))))
     (font-lock-string-face ((t (:background "#fffafa"))))
     (font-lock-type-face ((t (:foreground "black"))))
     (font-lock-variable-name-face ((t (:foreground "black"))))
     (font-lock-warning-face ((t (:bold t :foreground "Red" :weight
bold))))
     (fringe ((t (:background "grey95"))))
     (header-line ((t (:bold t :weight bold :underline nil :background
